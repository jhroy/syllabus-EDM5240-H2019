...
# IL EST PARFOIS NÉCESSAIRE D'IMPORTER DES MODULES POUR Y AJOUTER DES FONCTIONNALITÉS
...
# PCQ LE SCRIPT VA TENTER DE S'IMPORTER LUI-MÊME ET ÇA CAUSE ERREUR
...
# IL FAUT PLACER CE FICHIER DANS LE MÊME RÉPERTOIRE QUE CELUI DANS LEQUEL VOTRE SCRIPT EST SAUVEGARDÉ
...
# QUI VA LIRE NOTRE OBJET ET TOUT PLACER DANS UNE VARIABLE QU'ON PEUT APPELLER «lignes»
...
# LA COMMANDE CI-DESSOUS PERMET D'AFFICHER LA 4E COLONNE DE CHACUNE DES LIGNES DE NOTRE CSV
	print(ligne[3])
...
# ATTENTION -->> IL FAUT CONVERTIR NOTRE ligne-5 EN «float» POUR L'UTILISER DANS LE CALCUL QUI S'EN VIENT
